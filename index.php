...
<?php
$selecti = "select * from room_type";
$runi = mysqli_query($con, $selecti);
while($fetchi=mysqli_fetch_assoc($runi)){
    ?>
    <div class="carousel-item active">
      <img src="images/<?php echo $fetchi['img']; ?>" class="d-block w-100" alt="...">
    </div>
    <?php
}
?>
